...
-- at runtime using the environment variable srtree_bindir.
...
-- environment variable srtree_libdir.
...
-- using the environment variable srtree_dynlibdir.
...
-- runtime using the environment variable srtree_datadir.
...
-- using the environment variable srtree_sysconfdir.
...
libdir     = "/home/olivetti/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7/srtree-2.0.1.8-inplace"
dynlibdir  = "/home/olivetti/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7"
datadir    = "/home/olivetti/.cabal/share/x86_64-linux-ghc-9.14.1-ade7/srtree-2.0.1.8"
libexecdir = "/home/olivetti/.cabal/libexec/x86_64-linux-ghc-9.14.1-ade7/srtree-2.0.1.8"
sysconfdir = "/home/olivetti/.cabal/etc"

getBinDir     = catchIO (getEnv "srtree_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "srtree_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "srtree_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "srtree_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "srtree_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "srtree_sysconfdir") (\_ -> return sysconfdir)
