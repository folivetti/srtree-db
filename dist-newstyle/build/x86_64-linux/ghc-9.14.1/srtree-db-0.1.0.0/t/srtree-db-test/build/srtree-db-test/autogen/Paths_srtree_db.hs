...
-- at runtime using the environment variable srtree_db_bindir.
...
-- environment variable srtree_db_libdir.
...
-- using the environment variable srtree_db_dynlibdir.
...
-- runtime using the environment variable srtree_db_datadir.
...
-- using the environment variable srtree_db_sysconfdir.
...
libdir     = "/home/olivetti/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7/srtree-db-0.1.0.0-inplace-srtree-db-test"
dynlibdir  = "/home/olivetti/.cabal/lib/x86_64-linux-ghc-9.14.1-ade7"
datadir    = "/home/olivetti/.cabal/share/x86_64-linux-ghc-9.14.1-ade7/srtree-db-0.1.0.0"
libexecdir = "/home/olivetti/.cabal/libexec/x86_64-linux-ghc-9.14.1-ade7/srtree-db-0.1.0.0"
sysconfdir = "/home/olivetti/.cabal/etc"

getBinDir     = catchIO (getEnv "srtree_db_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "srtree_db_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "srtree_db_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "srtree_db_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "srtree_db_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "srtree_db_sysconfdir") (\_ -> return sysconfdir)
